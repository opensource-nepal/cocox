...
This document outlines the code of conduct for contributors, maintainers, and users of the "cocox" project. It aims to foster an inclusive and respectful community, promoting collaboration and positive interactions. By participating in this project, you are expected to adhere to this code of conduct. This code of conduct applies to all project-related spaces, including GitHub repositories, issue trackers, mailing lists, and social media platforms associated with the project.

## Our Pledge

In the interest of fostering an open and welcoming environment, we, as contributors, maintainers, and users of the cocox project, pledge to make participation in our community a harassment-free experience for everyone, regardless of age, body size, disability, ethnicity, gender identity and expression, level of experience, nationality, personal appearance, race, religion, or sexual orientation.
...
It is the same text used by [opensource-nepal/commitlint](https://github.com/opensource-nepal/commitlint), with the project name changed, so that both projects in the organization hold contributors to one standard.
